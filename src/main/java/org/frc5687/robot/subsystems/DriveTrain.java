...
public class DriveTrain extends OutliersSubsystem {
    ...
    private boolean _isLowGear = false; // we can also keep track of it here for drive logic, but keep in mind that this
                                        // is primarily tracked by Shifter subsystem and all shifting logic should
                                        // happen there. - xavier bradford 03/02/24
