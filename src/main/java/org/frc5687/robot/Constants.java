...
public class Constants {
    ...
    public static class SwerveModule {
        ...
        public static final double WHEEL_RADIUS = 0.0508; // 4in
        public static final double GEAR_RATIO_DRIVE_LOW = (52.0 / 13.0) * (54.0 / 42.0) * (45.0 / 15.0) * (16.0 / 36.0);
        public static final double GEAR_RATIO_DRIVE_HIGH = (52.0 / 13.0) * (44.0 / 52.0) * (45.0 / 15.0) * (16.0 / 36.0);
