...
public class DriveLights extends OutliersCommand {
    ...
    public DriveLights(Lights lights, DriveTrain driveTrain, Intake intake, VisionProcessor visionProcessor, Shooter shooter, OI oi, Dunker dunker) {
        _lights = lights;
    ...
    switch (_lights.getLightState()) 
{
 ...
 // this should never make the lights purple, like ever, but we need it for the empty check
